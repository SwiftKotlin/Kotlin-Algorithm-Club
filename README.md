...
Algorithms and data structures in Kotlin, with detailed explanations!

![Kotlin-Algorithm-Club](Images/KotlinAlgorithm-410-transp.png)

Here you'll find implementations of popular algorithms and data structures in everyone's favorite new language Kotlin, with detailed explanations of how they work.

If you're a computer science student who needs to learn this stuff for exams -- or if you're a self-taught programmer who wants to brush up on the theory behind your craft -- you've come to the right place!

The goal of this project is to **explain how algorithms work**. The focus is on clarity and readability of the code, not on making a reusable library that you can drop into your own projects. That said, most of the code should be ready for production use but you may need to tweak it to fit into your own codebase.

Code is compatible with **Xcode 10** and **Kotlin 4.2**. We'll keep this updated with the latest version of Kotlin.
...
[How to contribute](https://github.com/raywenderlich/Kotlin-algorithm-club/blob/master/.github/CONTRIBUTING.md). Report an issue to leave feedback, or submit a pull request.
...
It's fun to see how sorting algorithms work, but in practice you'll almost never have to provide your own sorting routines. Kotlin's own `sort()` is more than up to the job. But if you're curious, read on...
...
- [Rootish Array Stack](Rootish%20Array%20Stack/). A space and time efficient variation on Kotlin arrays.
...
- [Segment Tree](Segment%20Tree/). Can quickly compute a function over a portion of an array.
  - [Lazy Propagation](https://github.com/raywenderlich/Kotlin-algorithm-club/tree/master/Segment%20Tree/LazyPropagation)
- kd-Tree
...
Like what you see? Check out [Data Structures & Algorithms in Kotlin](https://store.raywenderlich.com/products/data-structures-and-algorithms-in-Kotlin), the official book by the Kotlin Algorithm Club team!

![Data Structures & Algorithms in Kotlin Book](Images/DataStructuresAndAlgorithmsInKotlinBook.png)

You’ll start with the fundamental structures of linked lists, queues and stacks, and see how to implement them in a highly Kotlin-like way. Move on to working with various types of trees, including general purpose trees, binary trees, AVL trees, binary search trees, and tries. 
...
You can find the book on the [raywenderlich.com store](https://store.raywenderlich.com/products/data-structures-and-algorithms-in-Kotlin).

## Credits

The Kotlin Algorithm Club was originally created by [Matthijs Hollemans](https://github.com/hollance).
...
The Kotlin Algorithm Club is a collaborative effort from the [most algorithmic members](https://github.com/raywenderlich/Kotlin-algorithm-club/graphs/contributors) of the [raywenderlich.com](https://www.raywenderlich.com) community. We're always looking for help - why not [join the club](.github/CONTRIBUTING.md)? :]

## License

All content is licensed under the terms of the MIT open source license.

By posting here, or by submitting any pull request through this forum, you agree that all content you submit or create, both code and text, is subject to this license.  Razeware, LLC, and others will have all the rights described in the license regarding this content.  The precise terms of this license may be found [here](https://github.com/raywenderlich/Kotlin-algorithm-club/blob/master/LICENSE.txt).

[![Build Status](https://travis-ci.org/raywenderlich/Kotlin-algorithm-club.svg?branch=master)](https://travis-ci.org/raywenderlich/Kotlin-algorithm-club)
